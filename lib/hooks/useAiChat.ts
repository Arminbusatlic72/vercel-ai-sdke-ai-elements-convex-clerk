...
//   // 1. Manual state for the textarea
...
//   // 2. Format initialMessages for AI SDK
//   const formattedInitialMessages = useMemo(() => {
//     return initialMessages.map((msg) => ({
//       id: msg._id, // optional, can remove if undefined
//       role: msg.role as "user" | "assistant",
//       parts: [{ type: "text", text: msg.content }]
//     }));
//   }, [initialMessages]);

//   // 3. Track if we've loaded initialMessages into useChat
//   const [initialLoaded, setInitialLoaded] = useState(false);

//   const { messages, sendMessage, status, setMessages } = useChat({
//     api: "/api/chat",
//     // ✅ Pass empty array here to avoid overwriting messages on remount
//     initialMessages: initialLoaded ? [] : formattedInitialMessages,
//     body: { model, webSearch, chatId }
//   });

//   // ✅ Hydrate messages only once
//   useEffect(() => {
...
//   // ✅ Sync initial messages to prevent re-saving
//   useEffect(() => {
