...
// import { NavigationContext } from "../lib/NavigationProvider";
// import { Id } from "@/convex/_generated/dataModel";
// import { Search, X, Home, Plus } from "lucide-react";
// import SidebarGpts from "./SidebarGpts";
// import SidebarChats from "./SidebarChats";
// import SidebarProjects from "./SidebarProjects";
...
//   // Search query - FIXED: Use debouncedSearch properly
//   const filteredChats =
//     useQuery(
//       api.chats.searchChats,
//       debouncedSearch.trim() // Only search when there's actual text
//         ? {
...
//         search: debouncedSearch,
//         hasSearchTerm: debouncedSearch.trim().length > 0,
//         filteredResults: filteredChats?.length || 0,
//         projectId: selectedProjectId || "none"
//       });
//     }
//   }, [debouncedSearch, filteredChats, selectedProjectId]);
...
//     }
//     return globalChats;
//   }, [debouncedSearch, filteredChats, globalChats]);
...
//               {/* <span className="font-semibold text-gray-900">GPT Dashboard</span> */}
//             </Link>
